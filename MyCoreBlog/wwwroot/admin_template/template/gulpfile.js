...
gulp.task('injectCommonAssets', function () {
  return gulp.src('./**/*.html')
    .pipe(inject(gulp.src([ 
        './~/admin_template/template/vendors/feather/feather.css',
        './~/admin_template/template/vendors/mdi/css/materialdesignicons.min.css',
        './~/admin_template/template/vendors/ti-icons/css/themify-icons.css',
        './~/admin_template/template/vendors/typicons/typicons.css',
        './~/admin_template/template/vendors/simple-line-icons/css/simple-line-icons.css',
        './~/admin_template/template/vendors/css/vendor.bundle.base.css', 
        './~/admin_template/template/vendors/js/vendor.bundle.base.js',
...
gulp.task('clean:vendors', function () {
    return del([
      '~/admin_template/template/vendors/**/*'
    ]);
});
...
gulp.task('buildBaseVendorScripts', function() {
    return gulp.src([
      ...
      .pipe(gulp.dest('./~/admin_template/template/vendors/js'));
});
...
gulp.task('copyAddonsStyles', function() {
    var aStyle1 = gulp.src(['./node_modules/@mdi/font/css/materialdesignicons.min.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/mdi/css'));
    var aStyle2 = gulp.src(['./node_modules/@mdi/font/fonts/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/mdi/fonts'));
    var aStyle3 = gulp.src(['./node_modules/font-awesome/css/font-awesome.min.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/font-awesome/css'));
    var aStyle4 = gulp.src(['./node_modules/font-awesome/fonts/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/font-awesome/fonts'));
    var aStyle5 = gulp.src(['./node_modules/flag-icon-css/css/flag-icon.min.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/flag-icon-css/css'));
    var aStyle6 = gulp.src(['./node_modules/flag-icon-css/flags/**/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/flag-icon-css/flags'));
    var aStyle7 = gulp.src(['./node_modules/simple-line-icons/css/simple-line-icons.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/simple-line-icons/css'));
    var aStyle8 = gulp.src(['./node_modules/simple-line-icons/fonts/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/simple-line-icons/fonts'));
    var aStyle9 = gulp.src(['./node_modules/ti-icons/css/themify-icons.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/ti-icons/css'));
    var aStyle10 = gulp.src(['./node_modules/ti-icons/fonts/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/ti-icons/fonts'));  
    ...
    var aStyle30 = gulp.src(['node_modules/jquery-asColorPicker/dist/css/asColorPicker.min.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/jquery-asColorPicker/css'));
    var aStyle31 = gulp.src(['node_modules/jquery-asColorPicker/dist/images/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/jquery-asColorPicker/images'));
    ...
    var aStyle35 = gulp.src(['node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/select2-bootstrap-theme'));
    ...
    var aStyle51 = gulp.src(['node_modules/ion-rangeslider/css/ion.rangeSlider.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/ion-rangeslider/css'));
    var aStyle52 = gulp.src(['node_modules/dropzone/dist/dropzone.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/dropzone'));
    var aStyle53 = gulp.src(['node_modules/ion-rangeslider/img/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/ion-rangeslider/img'));
    ...
    var aStyle56 = gulp.src(['./node_modules/puse-icons-feather/feather.css'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/feather'));
    var aStyle57 = gulp.src(['./node_modules/puse-icons-feather/fonts/*'])
        .pipe(gulp.dest('./~/admin_template/template/vendors/feather/fonts'));
    var aStyle58 = gulp.src(['node_modules/typicons.font/src/font/*'])
    .pipe(gulp.dest('./~/admin_template/template/vendors/typicons'));
...
gulp.task('copyMapFiles', function() {
    ...
    var map3 = gulp.src('node_modules/jquery-contextmenu/dist/jquery.contextMenu.min.css.map')
        .pipe(gulp.dest('./~/admin_template/template/vendors/jquery-contextmenu'));
